...
def nodePresetReformat():      
      nuke.setPreset("Reformat", "iPad/Retina Display", {'box_height': '2048', 'box_width': '1536', 'type': 'to box', 'box_fixed': 'true', 'label': '1536p Retina\n([value box_width]x[value box_height])', 'note_font': 'Helvetica'})
      nuke.setPreset("Reformat", "iPad/iPad Display", {'box_height': '1024', 'box_width': '768', 'type': 'to box', 'box_fixed': 'true', 'label': '768p iPad\n([value box_width]x[value box_height])', 'note_font': 'Helvetica'})
